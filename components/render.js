  ...
  data.comments
    ...
    .map((commentAndReplies) => {
      ...
      commentDiv.innerHTML = `<div class="votingSec">
            ...
            ${
              !isOwnComment
                ? `<button class="addReplyBtn addReplyBtn${commentAndReplies.id}mob">
                ...
                : ` <button class="deleteBtn deleteBtn${commentAndReplies.id}mob">
                ...
                <button class="editBtn editBtn${commentAndReplies.id}mob">
      ...
      if (!isOwnComment) {
        ...
        const addReplyBtnMob = document.querySelector(
          `.addReplyBtn${commentAndReplies.id}mob`
        );
